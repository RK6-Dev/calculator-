...
def promath():
    ...
    if userchoice1 == 1:
        ...
        if userareachoice == 2:
            ...
            again()
        if userareachoice == 4:
            Diameter = int(input("please enter the Diameter for the circle"))
    ...
    if userchoice1 == 2:
            ...
            print("press 4 to calculate the area for the circle ")
            print("=================================================================")
            userperi = int(input("please choose "))
            if userperi == 1:
              length = float(input("please enter the length"))
              ...
              print("the perimeter of this rectangle is ", (width + length) * 2)
              again()
            elif userperi == 4:
                 Diameter1: float = float(input("please enter the Diameter"))
    ...
    if userchoice1 == 3:
        ...
        if callfirt == 1:
            ...
            print("the square root for ", n1, math.sqrt(n1))
            again()
        else:
            print("invalid number")
            again()
        # *---------------------------------------
def again():
    againi = input("would you lik to try again? y/n")
    if againi == 'y':
        promath()
    else:
